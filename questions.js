...
module.exports = {
    initialQs: [{
      ...
      },
      {
        type: 'confirm',
        name: 'url_check',
        message: "Has a URL been chosen? (If 'Y' you'll need to provide it in the next question)"
      },
      {
        type: 'input',
        name: 'url',
        message: "What is the URL? (only include domain name + tld, eg. 'ufcutas.org')",
      ...
      },
      {
        type: 'checkbox',
        name: 'scaffold',
        message: "What would you like to scaffold for this project? (Use space to select all which apply)",
        choices: [
          {
            name: 'NextJS'
          },
